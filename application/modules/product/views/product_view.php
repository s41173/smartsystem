...
<script type="text/javascript">
	...
	$(function(){
			...
			$(document).on('click','.text-desc',function(e)
			{
				alert('hello');
				/*var sites = "<?php echo site_url('product/update/');?>";
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" >
                ...
                <div class="x_content">
                 ...
                 <!-- Search Form -->
                <form name="modul_form" class="form-inline" id="form" method="post" action="<?php echo $form_action; ?>">
                  <div class="form-group">
                    <label class="sr-only" for="exampleInputEmail3"> Category </label>
                    <?php $js = "class='select2_single form-control' id='cparent' tabindex='-1' style='min-width:100px;' ";  
		             echo form_dropdown('ccategory', $category, isset($default['category']) ? $default['category'] : '', $js); ?> &nbsp;
                  </div>
                  
                  <div class="form-group">
                    <label class="sr-only" for="exampleInputPassword3">Product Name</label>
                    <input id="tsearch" class="form-control col-md-7 col-xs-12" type="text" name="tsearch" placeholder="Product Name"> &nbsp;
