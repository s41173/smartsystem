...
<form id="upload_form_edit" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="<?php echo $form_action_update; ?>" 
    ...
    <div class="form-group">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="tname_update" class="form-control col-md-7 col-xs-12" type="text" name="tname" readonly required placeholder="Role">
      ...
      <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <select name="crules" id="crules_update" class="form-control" title="Rules" required>
