	...
	<div class="container_12">
			...
			<div class="grid_12" id="container">
				...
				<div class="grid_12" id="loginplace">
					...
					<div id="logos" style="margin: 15px 0 0 365px;"> <img align="middle" width="212" height="150" src="<?php echo $logo; ?>" alt="<?php echo $pname; ?>" /> </div> 
					<div class="clear"></div>
				
					<div id="loginbox">
					<?php echo validation_errors(); ?>
						<fieldset class="field">
						<p style="text-align:center; font-weight:bolder; "> Web base ERP System </p>
